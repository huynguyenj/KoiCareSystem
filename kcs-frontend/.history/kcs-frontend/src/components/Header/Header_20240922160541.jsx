   ...
   <>
      ...
      <nav className="navbar d-flex">
        ...
        <div className='navbar-right'>
          ...
          <a className='Menu 'href=""> <FontAwesomeIcon icon={faUserTie} style={{color: "#ffffff",}} /></a>
          <a className='Menu 'href=""> <FontAwesomeIcon icon={faCartShopping} style={{color: "#ffffff",}} /></a>
