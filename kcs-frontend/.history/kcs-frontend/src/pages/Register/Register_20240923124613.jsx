                ...
                <Col>
                  ...
                  >
                    ...
                    <Form onSubmit={handleSubmit}>
                      ...
                      <Form.Group controlId="formPassword" className="mb-3">
                        <Form.Control type="number" placeholder="Mật khẩu" value={password} onChange={(e)=>{setPassword(e.target.value)}} />
                      </Form.Group>
                    ...
                    <p className="mt-3 text-center">
                      Bạn chưa có tài khoản? Hãy <span><a href="" style={{color:'red',fontSize:'18px'}} onClick={changePage}>Đăng ký</a></span> trước khi đăng nhập.
                    </p>
                  </div>
                </Col>
              </Row>
