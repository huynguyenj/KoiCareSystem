                ...
                <Col>
                  ...
                  >
                    <div className="d-flex justify-content-between mb-3">
                      <Button variant="light" className="w-50" style={{marginRight: "20px"}} onClick={()=>setCurr("register")}>
                        Đăng Ký
                      </Button>
                      <Button variant="danger" className="w-50" onClick={()=>setCurr("login")}>
                        Đăng Nhập
                      </Button>
                    </div>
                    <Form>
                        {curr =="login"? <></>:<><Form.Group controlId="formUsername" className="mb-3">
